...
export function useGetAllPeopleSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetAllPeopleQuery, GetAllPeopleQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetAllPeopleQuery, GetAllPeopleQueryVariables>(GetAllPeopleDocument, options);
        }
